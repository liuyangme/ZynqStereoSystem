 ...
 * ov5640_config.c
 *
 *  Created on: 2016濡ょ姷鍎戦幏锟�10闂佸搫鐗為幏锟�23闂佸搫鍠涢幏锟�
 ...
 * ov7725_config.c
 *
 *  Created on: 2016濡ょ姷鍎戦幏锟�10闂佸搫鐗為幏锟�22闂佸搫鍠涢幏锟�
 *      Author: Administrator
 */
#include"sleep.h"
#include"i2c_ctr.h"
...
void ov5640_init_rgb(void)
{
	 ...
	 sccb_senddata(0x43,0x00,0x61);// RGB565
	 ...
	 sccb_senddata(0x30,0x35, 0x21); // PLL
	 ...
	 sccb_senddata(0x38,0x20, 0x40); // flip
	 sccb_senddata(0x38,0x21, 0x07); // mirror
	 ...
	 sccb_senddata(0x3a,0x08, 0x00); // B50 step
	 sccb_senddata(0x3a,0x09, 0x6f); // B50 step
	 sccb_senddata(0x3a,0x0a, 0x00); // B60 step
	 sccb_senddata(0x3a,0x0b, 0x5c); // B60 step
	 sccb_senddata(0x3a,0x0e, 0x06); // 50Hz max band
	 sccb_senddata(0x3a,0x0d, 0x08); // 60Hz max band
	 ...
	 sccb_senddata(0x50,0x01, 0xa3); // SDE on, CMX on, AWB on
