...
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_IIC_0_tri_io[0]}]
set_property PULLUP true [get_ports {EMIO_IIC_0_tri_io[0]}]
# "CMOS_SDAT"
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_IIC_0_tri_io[1]}]
set_property PACKAGE_PIN L15 [get_ports {EMIO_IIC_0_tri_io[1]}]
set_property PULLUP true [get_ports {EMIO_IIC_0_tri_io[1]}]
# "CMOS_VSYNC"
...
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_IIC_0_tri_io[2]}]
set_property PULLUP true [get_ports {EMIO_IIC_0_tri_io[2]}]
# "CMOS_SDAT"
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_IIC_0_tri_io[3]}]
set_property PACKAGE_PIN J14 [get_ports {EMIO_IIC_0_tri_io[3]}]
set_property PULLUP true [get_ports {EMIO_IIC_0_tri_io[3]}]
# "CMOS_VSYNC"
...
create_clock -period 10.000 -name cmos_xclk_o_1 [get_ports cmos_xclk_o_1]
set_property SLEW FAST [get_ports cmos_xclk_o_1]
