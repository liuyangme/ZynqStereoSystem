...
proc create_root_design { parentCell } {
  ...
  # Create instance: OV5640_Sensor_1, and set properties
  set OV5640_Sensor_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:OV5640_Sensor:1.0 OV5640_Sensor_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_10_AXI_AR_SEL_DATA {1} \
   CONFIG.C_SLOT_10_AXI_AR_SEL_TRIG {1} \
   CONFIG.C_SLOT_10_AXI_AW_SEL_DATA {1} \
   CONFIG.C_SLOT_10_AXI_AW_SEL_TRIG {1} \
   CONFIG.C_SLOT_10_AXI_B_SEL_DATA {1} \
   CONFIG.C_SLOT_10_AXI_B_SEL_TRIG {1} \
   CONFIG.C_SLOT_10_AXI_R_SEL_DATA {1} \
   CONFIG.C_SLOT_10_AXI_R_SEL_TRIG {1} \
   CONFIG.C_SLOT_10_AXI_W_SEL_DATA {1} \
   CONFIG.C_SLOT_10_AXI_W_SEL_TRIG {1} \
   CONFIG.C_SLOT_10_INTF_TYPE {xilinx.com:interface:aximm_rtl:1.0} \
   CONFIG.C_SLOT_11_APC_EN {0} \
   CONFIG.C_SLOT_11_AXI_AR_SEL_DATA {1} \
   CONFIG.C_SLOT_11_AXI_AR_SEL_TRIG {1} \
   CONFIG.C_SLOT_11_AXI_AW_SEL_DATA {1} \
   CONFIG.C_SLOT_11_AXI_AW_SEL_TRIG {1} \
   CONFIG.C_SLOT_11_AXI_B_SEL_DATA {1} \
   CONFIG.C_SLOT_11_AXI_B_SEL_TRIG {1} \
   CONFIG.C_SLOT_11_AXI_R_SEL_DATA {1} \
   CONFIG.C_SLOT_11_AXI_R_SEL_TRIG {1} \
   CONFIG.C_SLOT_11_AXI_W_SEL_DATA {1} \
   CONFIG.C_SLOT_11_AXI_W_SEL_TRIG {1} \
   CONFIG.C_SLOT_11_INTF_TYPE {xilinx.com:interface:aximm_rtl:1.0} \
   CONFIG.C_SLOT_12_APC_EN {0} \
   CONFIG.C_SLOT_12_AXI_AR_SEL_DATA {1} \
   CONFIG.C_SLOT_12_AXI_AR_SEL_TRIG {1} \
   CONFIG.C_SLOT_12_AXI_AW_SEL_DATA {1} \
   CONFIG.C_SLOT_12_AXI_AW_SEL_TRIG {1} \
   CONFIG.C_SLOT_12_AXI_B_SEL_DATA {1} \
   CONFIG.C_SLOT_12_AXI_B_SEL_TRIG {1} \
   CONFIG.C_SLOT_12_AXI_R_SEL_DATA {1} \
   CONFIG.C_SLOT_12_AXI_R_SEL_TRIG {1} \
   CONFIG.C_SLOT_12_AXI_W_SEL_DATA {1} \
   CONFIG.C_SLOT_12_AXI_W_SEL_TRIG {1} \
   CONFIG.C_SLOT_12_INTF_TYPE {xilinx.com:interface:aximm_rtl:1.0} \
   CONFIG.C_SLOT_13_APC_EN {0} \
   CONFIG.C_SLOT_13_AXI_AR_SEL_DATA {1} \
   CONFIG.C_SLOT_13_AXI_AR_SEL_TRIG {1} \
   CONFIG.C_SLOT_13_AXI_AW_SEL_DATA {1} \
   CONFIG.C_SLOT_13_AXI_AW_SEL_TRIG {1} \
   CONFIG.C_SLOT_13_AXI_B_SEL_DATA {1} \
   CONFIG.C_SLOT_13_AXI_B_SEL_TRIG {1} \
   CONFIG.C_SLOT_13_AXI_R_SEL_DATA {1} \
   CONFIG.C_SLOT_13_AXI_R_SEL_TRIG {1} \
   CONFIG.C_SLOT_13_AXI_W_SEL_DATA {1} \
   CONFIG.C_SLOT_13_AXI_W_SEL_TRIG {1} \
   CONFIG.C_SLOT_13_INTF_TYPE {xilinx.com:interface:aximm_rtl:1.0} \
   CONFIG.C_SLOT_14_APC_EN {0} \
   CONFIG.C_SLOT_14_AXI_AR_SEL_DATA {1} \
   CONFIG.C_SLOT_14_AXI_AR_SEL_TRIG {1} \
   CONFIG.C_SLOT_14_AXI_AW_SEL_DATA {1} \
   CONFIG.C_SLOT_14_AXI_AW_SEL_TRIG {1} \
   CONFIG.C_SLOT_14_AXI_B_SEL_DATA {1} \
   CONFIG.C_SLOT_14_AXI_B_SEL_TRIG {1} \
   CONFIG.C_SLOT_14_AXI_R_SEL_DATA {1} \
   CONFIG.C_SLOT_14_AXI_R_SEL_TRIG {1} \
   CONFIG.C_SLOT_14_AXI_W_SEL_DATA {1} \
   CONFIG.C_SLOT_14_AXI_W_SEL_TRIG {1} \
   CONFIG.C_SLOT_14_INTF_TYPE {xilinx.com:interface:aximm_rtl:1.0} \
  ...
  # Create instance: system_ila_6, and set properties
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_interconnect_1_M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins axi_vdma_3/S_AXI_LITE]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_2_M00_AXI] [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_14_AXI]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_interconnect_2_M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_2_M01_AXI [get_bd_intf_pins axi_interconnect_2/M01_AXI] [get_bd_intf_pins axi_vdma_2/S_AXI_LITE]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_2_M01_AXI] [get_bd_intf_pins axi_interconnect_2/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_13_AXI]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_interconnect_2_M01_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_3_M00_AXI] [get_bd_intf_pins axi_interconnect_3/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_12_AXI]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_vdma_1_M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_vdma_2_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_3/S01_AXI] [get_bd_intf_pins axi_vdma_2/M_AXI_MM2S]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_2_M_AXI_MM2S] [get_bd_intf_pins axi_vdma_2/M_AXI_MM2S] [get_bd_intf_pins system_ila_0/SLOT_11_AXI]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_vdma_2_M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_vdma_3_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_3/S00_AXI] [get_bd_intf_pins axi_vdma_3/M_AXI_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_3_M_AXI_S2MM] [get_bd_intf_pins axi_vdma_3/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_10_AXI]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_subset_converter_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_1_M_AXIS [get_bd_intf_pins axi_vdma_3/S_AXIS_S2MM] [get_bd_intf_pins axis_subset_converter_1/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_subset_converter_1_M_AXIS] [get_bd_intf_pins axis_subset_converter_1/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_9_AXIS]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets v_vid_in_axi4s_0_video_out]
  connect_bd_intf_net -intf_net v_vid_in_axi4s_1_video_out [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins v_vid_in_axi4s_1/video_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets v_vid_in_axi4s_1_video_out] [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_8_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets v_vid_in_axi4s_1_video_out]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/M01_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_3/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_2/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_2/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_2/s_axi_lite_aclk] [get_bd_pins axi_vdma_3/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_3/s_axi_lite_aclk] [get_bd_pins axi_vdma_3/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_1/clk] [get_bd_pins system_ila_2/clk] [get_bd_pins system_ila_3/clk] [get_bd_pins system_ila_4/clk] [get_bd_pins system_ila_5/clk] [get_bd_pins system_ila_6/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins v_vid_in_axi4s_1/aclk]
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets OV5640_Sensor_0_rgb_o]
  ...
  connect_bd_net -net OV5640_Sensor_1_cmos_xclk_o [get_bd_ports cmos_xclk_o_1] [get_bd_pins OV5640_Sensor_1/cmos_xclk_o]
  connect_bd_net -net OV5640_Sensor_1_hs_o [get_bd_pins OV5640_Sensor_1/hs_o] [get_bd_pins v_vid_in_axi4s_1/vid_active_video] [get_bd_pins v_vid_in_axi4s_1/vid_hsync]
  connect_bd_net -net OV5640_Sensor_1_rgb_o [get_bd_pins OV5640_Sensor_1/rgb_o] [get_bd_pins system_ila_4/probe0] [get_bd_pins v_vid_in_axi4s_1/vid_data]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets OV5640_Sensor_1_rgb_o]
  connect_bd_net -net OV5640_Sensor_1_vid_clk_ce [get_bd_pins OV5640_Sensor_1/vid_clk_ce] [get_bd_pins v_vid_in_axi4s_1/vid_io_in_ce]
  connect_bd_net -net OV5640_Sensor_1_vs_o [get_bd_pins OV5640_Sensor_1/vs_o] [get_bd_pins v_vid_in_axi4s_1/vid_vsync]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/M01_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_3/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins axi_vdma_2/axi_resetn] [get_bd_pins axi_vdma_3/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net cmos_data_i_1_1 [get_bd_ports cmos_data_i_1] [get_bd_pins OV5640_Sensor_1/cmos_data_i]
  connect_bd_net -net cmos_href_i_0_1 [get_bd_ports cmos_href_i_0] [get_bd_pins OV5640_Sensor_0/cmos_href_i]
  connect_bd_net -net cmos_href_i_1_1 [get_bd_ports cmos_href_i_1] [get_bd_pins OV5640_Sensor_1/cmos_href_i]
  ...
  connect_bd_net -net cmos_pclk_i_1_1 [get_bd_ports cmos_pclk_i_1] [get_bd_pins OV5640_Sensor_1/cmos_pclk_i] [get_bd_pins v_vid_in_axi4s_1/vid_io_in_clk]
  connect_bd_net -net cmos_vsync_i_0_1 [get_bd_ports cmos_vsync_i_0] [get_bd_pins OV5640_Sensor_0/cmos_vsync_i]
  connect_bd_net -net cmos_vsync_i_1_1 [get_bd_ports cmos_vsync_i_1] [get_bd_pins OV5640_Sensor_1/cmos_vsync_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins OV5640_Sensor_0/clk_i] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins system_ila_5/probe0]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets processing_system7_0_FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins OV5640_Sensor_1/clk_i] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins system_ila_6/probe0]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets processing_system7_0_FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net sw1_1 [get_bd_ports sw1] [get_bd_pins util_vector_logic_2/Op1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset] [get_bd_pins v_vid_in_axi4s_1/vid_io_in_reset]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets xlconcat_0_dout]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins xlconstant_1/dout]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_vdma_3/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_2/S_AXI_LITE/Reg] SEG_axi_vdma_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x83010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_3/S_AXI_LITE/Reg] SEG_axi_vdma_3_Reg
