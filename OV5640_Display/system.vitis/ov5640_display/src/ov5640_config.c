...
{	
	...
	{0x583b,0x28},
	{0x583c,0x42},
	{0x583d,0xce},// lenc BR offset // AWB   �Զ���ƽ��
	...
	{0x538a,0x01},// sign[9]
	{0x538b,0x98}, // sign[8:1] // UV adjust  
	...
	{0x3035,0x41},// PLL  0x11
	{0x3036,0x69},// PLL  0x46
	{0x3c07,0x08},// light meter 1 threshold [7:0]
	{0x3820,0x41},// Sensor flip off, ISP flip on
	{0x3821,0x00},// Sensor mirror on, ISP mirror on, H binning on
	{0x3814,0x31},// X INC 
	{0x3815,0x31},// Y INC
	...
	{0x380a,0x02},// DVPVO
	{0x380b,0x58},// DVPVO
	{0x380c,0x07},// HTS            //Total horizontal size 1896
	{0x380d,0x68},// HTS
	{0x380e,0x03},// VTS            //total vertical size 984
	{0x380f,0xd8},// VTS 
	...
	{0x3a03,0x10},// 60Hz max exposure // banding filters are calculated automatically in camera drive
	...
	{0x3035,0x21},// PLL     input clock =24Mhz, PCLK =84Mhz
	{0x3036,0x69},// PLL
	...
	{0x5001,0xa3}, // SDE on, CMX on, AWB on, scale on
	{0x3503,0x00}, // AEC/AGC on 
...
{
	*read_buf=i2c_reg16_read(IicInstance,0x78,addr);
	return XST_SUCCESS;
}
...
int ov5640_write(XIicPs *IicInstance,u16 addr,u8 data)
{
	...
	return i2c_reg16_write(IicInstance,0x78,addr,data);
}
