...
HD_PWD='E:/Project/Personal/StereoVision/Project_FPGA/Stereo-Display-ZYNQ/ControlBoardTest/system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_test.tcl
