...
HD_PWD='E:/Project/Personal/StereoVision/Project_FPGA/Stereo-Display-ZYNQ/ControlBoardTest/system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_test.tcl -notrace
