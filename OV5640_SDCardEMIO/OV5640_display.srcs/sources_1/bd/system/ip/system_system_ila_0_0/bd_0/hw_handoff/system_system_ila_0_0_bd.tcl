...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXIS:SLOT_1_AXI:SLOT_2_AXI:SLOT_3_AXI:SLOT_4_AXI:SLOT_5_AXIS:SLOT_6_AXIS:SLOT_7_AXI} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_7_HAS_CACHE {0} \
   CONFIG.C_SLOT_7_HAS_LOCK {0} \
   CONFIG.C_SLOT_7_HAS_PROT {0} \
...
connect_bd_intf_net -intf_net Conn7 [get_bd_intf_ports SLOT_7_AXI] [get_bd_intf_pins g_inst/slot_7_axi]
  ...
  connect_bd_net -net net_slot_2_axi_ar_ctrl [get_bd_pins ila_lib/probe47] [get_bd_pins slot_2_ar/dout]
  ...
  connect_bd_net -net net_slot_2_axi_aw_cnt [get_bd_pins g_inst/m_slot_2_axi_aw_cnt] [get_bd_pins ila_lib/probe35]
  connect_bd_net -net net_slot_2_axi_aw_ctrl [get_bd_pins ila_lib/probe44] [get_bd_pins slot_2_aw/dout]
  connect_bd_net -net net_slot_2_axi_awaddr [get_bd_pins g_inst/m_slot_2_axi_awaddr] [get_bd_pins ila_lib/probe36]
  ...
  connect_bd_net -net net_slot_2_axi_b_cnt [get_bd_pins g_inst/m_slot_2_axi_b_cnt] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_2_axi_b_ctrl [get_bd_pins ila_lib/probe46] [get_bd_pins slot_2_b/dout]
  connect_bd_net -net net_slot_2_axi_bready [get_bd_pins g_inst/m_slot_2_axi_bready] [get_bd_pins slot_2_b/In1]
  connect_bd_net -net net_slot_2_axi_bresp [get_bd_pins g_inst/m_slot_2_axi_bresp] [get_bd_pins ila_lib/probe38]
  connect_bd_net -net net_slot_2_axi_bvalid [get_bd_pins g_inst/m_slot_2_axi_bvalid] [get_bd_pins slot_2_b/In0]
  connect_bd_net -net net_slot_2_axi_r_cnt [get_bd_pins g_inst/m_slot_2_axi_r_cnt] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_2_axi_r_ctrl [get_bd_pins ila_lib/probe48] [get_bd_pins slot_2_r/dout]
  connect_bd_net -net net_slot_2_axi_rdata [get_bd_pins g_inst/m_slot_2_axi_rdata] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_2_axi_rready [get_bd_pins g_inst/m_slot_2_axi_rready] [get_bd_pins slot_2_r/In1]
  connect_bd_net -net net_slot_2_axi_rresp [get_bd_pins g_inst/m_slot_2_axi_rresp] [get_bd_pins ila_lib/probe41]
  connect_bd_net -net net_slot_2_axi_rvalid [get_bd_pins g_inst/m_slot_2_axi_rvalid] [get_bd_pins slot_2_r/In0]
  connect_bd_net -net net_slot_2_axi_w_ctrl [get_bd_pins ila_lib/probe45] [get_bd_pins slot_2_w/dout]
  connect_bd_net -net net_slot_2_axi_wdata [get_bd_pins g_inst/m_slot_2_axi_wdata] [get_bd_pins ila_lib/probe42]
  connect_bd_net -net net_slot_2_axi_wready [get_bd_pins g_inst/m_slot_2_axi_wready] [get_bd_pins slot_2_w/In1]
  connect_bd_net -net net_slot_2_axi_wstrb [get_bd_pins g_inst/m_slot_2_axi_wstrb] [get_bd_pins ila_lib/probe43]
  connect_bd_net -net net_slot_2_axi_wvalid [get_bd_pins g_inst/m_slot_2_axi_wvalid] [get_bd_pins slot_2_w/In0]
  connect_bd_net -net net_slot_3_axi_ar_cnt [get_bd_pins g_inst/m_slot_3_axi_ar_cnt] [get_bd_pins ila_lib/probe49]
  connect_bd_net -net net_slot_3_axi_ar_ctrl [get_bd_pins ila_lib/probe65] [get_bd_pins slot_3_ar/dout]
  connect_bd_net -net net_slot_3_axi_araddr [get_bd_pins g_inst/m_slot_3_axi_araddr] [get_bd_pins ila_lib/probe50]
  connect_bd_net -net net_slot_3_axi_arlen [get_bd_pins g_inst/m_slot_3_axi_arlen] [get_bd_pins ila_lib/probe51]
  connect_bd_net -net net_slot_3_axi_arready [get_bd_pins g_inst/m_slot_3_axi_arready] [get_bd_pins slot_3_ar/In1]
  connect_bd_net -net net_slot_3_axi_arsize [get_bd_pins g_inst/m_slot_3_axi_arsize] [get_bd_pins ila_lib/probe52]
  connect_bd_net -net net_slot_3_axi_arvalid [get_bd_pins g_inst/m_slot_3_axi_arvalid] [get_bd_pins slot_3_ar/In0]
  connect_bd_net -net net_slot_3_axi_aw_cnt [get_bd_pins g_inst/m_slot_3_axi_aw_cnt] [get_bd_pins ila_lib/probe53]
  connect_bd_net -net net_slot_3_axi_aw_ctrl [get_bd_pins ila_lib/probe62] [get_bd_pins slot_3_aw/dout]
  connect_bd_net -net net_slot_3_axi_awaddr [get_bd_pins g_inst/m_slot_3_axi_awaddr] [get_bd_pins ila_lib/probe54]
  connect_bd_net -net net_slot_3_axi_awlen [get_bd_pins g_inst/m_slot_3_axi_awlen] [get_bd_pins ila_lib/probe55]
  connect_bd_net -net net_slot_3_axi_awready [get_bd_pins g_inst/m_slot_3_axi_awready] [get_bd_pins slot_3_aw/In1]
  connect_bd_net -net net_slot_3_axi_awsize [get_bd_pins g_inst/m_slot_3_axi_awsize] [get_bd_pins ila_lib/probe56]
  connect_bd_net -net net_slot_3_axi_awvalid [get_bd_pins g_inst/m_slot_3_axi_awvalid] [get_bd_pins slot_3_aw/In0]
  connect_bd_net -net net_slot_3_axi_b_cnt [get_bd_pins g_inst/m_slot_3_axi_b_cnt] [get_bd_pins ila_lib/probe57]
  connect_bd_net -net net_slot_3_axi_b_ctrl [get_bd_pins ila_lib/probe64] [get_bd_pins slot_3_b/dout]
  ...
  connect_bd_net -net net_slot_3_axi_r_cnt [get_bd_pins g_inst/m_slot_3_axi_r_cnt] [get_bd_pins ila_lib/probe58]
  connect_bd_net -net net_slot_3_axi_r_ctrl [get_bd_pins ila_lib/probe66] [get_bd_pins slot_3_r/dout]
  connect_bd_net -net net_slot_3_axi_rdata [get_bd_pins g_inst/m_slot_3_axi_rdata] [get_bd_pins ila_lib/probe59]
  ...
  connect_bd_net -net net_slot_3_axi_rresp [get_bd_pins g_inst/m_slot_3_axi_rresp] [get_bd_pins ila_lib/probe60]
  connect_bd_net -net net_slot_3_axi_rvalid [get_bd_pins g_inst/m_slot_3_axi_rvalid] [get_bd_pins slot_3_r/In0]
  connect_bd_net -net net_slot_3_axi_w_ctrl [get_bd_pins ila_lib/probe63] [get_bd_pins slot_3_w/dout]
  connect_bd_net -net net_slot_3_axi_wdata [get_bd_pins g_inst/m_slot_3_axi_wdata] [get_bd_pins ila_lib/probe61]
  ...
  connect_bd_net -net net_slot_4_axi_ar_cnt [get_bd_pins g_inst/m_slot_4_axi_ar_cnt] [get_bd_pins ila_lib/probe67]
  connect_bd_net -net net_slot_4_axi_ar_ctrl [get_bd_pins ila_lib/probe84] [get_bd_pins slot_4_ar/dout]
  connect_bd_net -net net_slot_4_axi_araddr [get_bd_pins g_inst/m_slot_4_axi_araddr] [get_bd_pins ila_lib/probe68]
  connect_bd_net -net net_slot_4_axi_arlen [get_bd_pins g_inst/m_slot_4_axi_arlen] [get_bd_pins ila_lib/probe69]
  connect_bd_net -net net_slot_4_axi_arready [get_bd_pins g_inst/m_slot_4_axi_arready] [get_bd_pins slot_4_ar/In1]
  connect_bd_net -net net_slot_4_axi_arsize [get_bd_pins g_inst/m_slot_4_axi_arsize] [get_bd_pins ila_lib/probe70]
  connect_bd_net -net net_slot_4_axi_arvalid [get_bd_pins g_inst/m_slot_4_axi_arvalid] [get_bd_pins slot_4_ar/In0]
  connect_bd_net -net net_slot_4_axi_aw_cnt [get_bd_pins g_inst/m_slot_4_axi_aw_cnt] [get_bd_pins ila_lib/probe71]
  connect_bd_net -net net_slot_4_axi_aw_ctrl [get_bd_pins ila_lib/probe81] [get_bd_pins slot_4_aw/dout]
  connect_bd_net -net net_slot_4_axi_awaddr [get_bd_pins g_inst/m_slot_4_axi_awaddr] [get_bd_pins ila_lib/probe72]
  connect_bd_net -net net_slot_4_axi_awlen [get_bd_pins g_inst/m_slot_4_axi_awlen] [get_bd_pins ila_lib/probe73]
  connect_bd_net -net net_slot_4_axi_awready [get_bd_pins g_inst/m_slot_4_axi_awready] [get_bd_pins slot_4_aw/In1]
  connect_bd_net -net net_slot_4_axi_awsize [get_bd_pins g_inst/m_slot_4_axi_awsize] [get_bd_pins ila_lib/probe74]
  connect_bd_net -net net_slot_4_axi_awvalid [get_bd_pins g_inst/m_slot_4_axi_awvalid] [get_bd_pins slot_4_aw/In0]
  connect_bd_net -net net_slot_4_axi_b_cnt [get_bd_pins g_inst/m_slot_4_axi_b_cnt] [get_bd_pins ila_lib/probe75]
  connect_bd_net -net net_slot_4_axi_b_ctrl [get_bd_pins ila_lib/probe83] [get_bd_pins slot_4_b/dout]
  connect_bd_net -net net_slot_4_axi_bready [get_bd_pins g_inst/m_slot_4_axi_bready] [get_bd_pins slot_4_b/In1]
  connect_bd_net -net net_slot_4_axi_bresp [get_bd_pins g_inst/m_slot_4_axi_bresp] [get_bd_pins ila_lib/probe76]
  connect_bd_net -net net_slot_4_axi_bvalid [get_bd_pins g_inst/m_slot_4_axi_bvalid] [get_bd_pins slot_4_b/In0]
  connect_bd_net -net net_slot_4_axi_r_cnt [get_bd_pins g_inst/m_slot_4_axi_r_cnt] [get_bd_pins ila_lib/probe77]
  connect_bd_net -net net_slot_4_axi_r_ctrl [get_bd_pins ila_lib/probe85] [get_bd_pins slot_4_r/dout]
  connect_bd_net -net net_slot_4_axi_rdata [get_bd_pins g_inst/m_slot_4_axi_rdata] [get_bd_pins ila_lib/probe78]
  ...
  connect_bd_net -net net_slot_4_axi_w_ctrl [get_bd_pins ila_lib/probe82] [get_bd_pins slot_4_w/dout]
  connect_bd_net -net net_slot_4_axi_wdata [get_bd_pins g_inst/m_slot_4_axi_wdata] [get_bd_pins ila_lib/probe79]
  ...
  connect_bd_net -net net_slot_4_axi_wstrb [get_bd_pins g_inst/m_slot_4_axi_wstrb] [get_bd_pins ila_lib/probe80]
  connect_bd_net -net net_slot_4_axi_wvalid [get_bd_pins g_inst/m_slot_4_axi_wvalid] [get_bd_pins slot_4_w/In0]
  connect_bd_net -net net_slot_5_axis_tdata [get_bd_pins g_inst/m_slot_5_axis_tdata] [get_bd_pins ila_lib/probe86]
  connect_bd_net -net net_slot_5_axis_tlast [get_bd_pins g_inst/m_slot_5_axis_tlast] [get_bd_pins ila_lib/probe90]
  connect_bd_net -net net_slot_5_axis_tready [get_bd_pins g_inst/m_slot_5_axis_tready] [get_bd_pins ila_lib/probe89]
  connect_bd_net -net net_slot_5_axis_tuser [get_bd_pins g_inst/m_slot_5_axis_tuser] [get_bd_pins ila_lib/probe87]
  connect_bd_net -net net_slot_5_axis_tvalid [get_bd_pins g_inst/m_slot_5_axis_tvalid] [get_bd_pins ila_lib/probe88]
  connect_bd_net -net net_slot_6_axis_tdata [get_bd_pins g_inst/m_slot_6_axis_tdata] [get_bd_pins ila_lib/probe91]
  connect_bd_net -net net_slot_6_axis_tlast [get_bd_pins g_inst/m_slot_6_axis_tlast] [get_bd_pins ila_lib/probe95]
  connect_bd_net -net net_slot_6_axis_tready [get_bd_pins g_inst/m_slot_6_axis_tready] [get_bd_pins ila_lib/probe94]
  connect_bd_net -net net_slot_6_axis_tuser [get_bd_pins g_inst/m_slot_6_axis_tuser] [get_bd_pins ila_lib/probe92]
  connect_bd_net -net net_slot_6_axis_tvalid [get_bd_pins g_inst/m_slot_6_axis_tvalid] [get_bd_pins ila_lib/probe93]
  connect_bd_net -net net_slot_7_axi_ar_cnt [get_bd_pins g_inst/m_slot_7_axi_ar_cnt] [get_bd_pins ila_lib/probe96]
  connect_bd_net -net net_slot_7_axi_ar_ctrl [get_bd_pins ila_lib/probe110] [get_bd_pins slot_7_ar/dout]
  connect_bd_net -net net_slot_7_axi_araddr [get_bd_pins g_inst/m_slot_7_axi_araddr] [get_bd_pins ila_lib/probe97]
  ...
  connect_bd_net -net net_slot_7_axi_aw_cnt [get_bd_pins g_inst/m_slot_7_axi_aw_cnt] [get_bd_pins ila_lib/probe98]
  connect_bd_net -net net_slot_7_axi_aw_ctrl [get_bd_pins ila_lib/probe107] [get_bd_pins slot_7_aw/dout]
  connect_bd_net -net net_slot_7_axi_awaddr [get_bd_pins g_inst/m_slot_7_axi_awaddr] [get_bd_pins ila_lib/probe99]
  ...
  connect_bd_net -net net_slot_7_axi_b_cnt [get_bd_pins g_inst/m_slot_7_axi_b_cnt] [get_bd_pins ila_lib/probe100]
  connect_bd_net -net net_slot_7_axi_b_ctrl [get_bd_pins ila_lib/probe109] [get_bd_pins slot_7_b/dout]
  connect_bd_net -net net_slot_7_axi_bready [get_bd_pins g_inst/m_slot_7_axi_bready] [get_bd_pins slot_7_b/In1]
  connect_bd_net -net net_slot_7_axi_bresp [get_bd_pins g_inst/m_slot_7_axi_bresp] [get_bd_pins ila_lib/probe101]
  connect_bd_net -net net_slot_7_axi_bvalid [get_bd_pins g_inst/m_slot_7_axi_bvalid] [get_bd_pins slot_7_b/In0]
  connect_bd_net -net net_slot_7_axi_r_cnt [get_bd_pins g_inst/m_slot_7_axi_r_cnt] [get_bd_pins ila_lib/probe102]
  connect_bd_net -net net_slot_7_axi_r_ctrl [get_bd_pins ila_lib/probe111] [get_bd_pins slot_7_r/dout]
  connect_bd_net -net net_slot_7_axi_rdata [get_bd_pins g_inst/m_slot_7_axi_rdata] [get_bd_pins ila_lib/probe103]
  connect_bd_net -net net_slot_7_axi_rready [get_bd_pins g_inst/m_slot_7_axi_rready] [get_bd_pins slot_7_r/In1]
  connect_bd_net -net net_slot_7_axi_rresp [get_bd_pins g_inst/m_slot_7_axi_rresp] [get_bd_pins ila_lib/probe104]
  connect_bd_net -net net_slot_7_axi_rvalid [get_bd_pins g_inst/m_slot_7_axi_rvalid] [get_bd_pins slot_7_r/In0]
  connect_bd_net -net net_slot_7_axi_w_ctrl [get_bd_pins ila_lib/probe108] [get_bd_pins slot_7_w/dout]
  connect_bd_net -net net_slot_7_axi_wdata [get_bd_pins g_inst/m_slot_7_axi_wdata] [get_bd_pins ila_lib/probe105]
  connect_bd_net -net net_slot_7_axi_wready [get_bd_pins g_inst/m_slot_7_axi_wready] [get_bd_pins slot_7_w/In1]
  connect_bd_net -net net_slot_7_axi_wstrb [get_bd_pins g_inst/m_slot_7_axi_wstrb] [get_bd_pins ila_lib/probe106]
