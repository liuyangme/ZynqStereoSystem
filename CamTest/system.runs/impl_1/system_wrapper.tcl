...
set rc [catch {
  ...
  add_files -quiet E:/Project/Personal/PoseEstimation/ZYNQ/ZYNQ-SystemDebug/CamTest/system.runs/synth_1/system_wrapper.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source E:/Repository/MyIPcoreLib/DRCheckPass.tcl"
    source E:/Repository/MyIPcoreLib/DRCheckPass.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script E:/Repository/MyIPcoreLib/DRCheckPass.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
