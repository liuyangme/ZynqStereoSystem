...
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_OV_Sensor_ML_0_2 || ORIG_REF_NAME==system_OV_Sensor_ML_0_2}]
...
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_HDMI_FPGA_ML_0_0 || ORIG_REF_NAME==system_HDMI_FPGA_ML_0_0}]
