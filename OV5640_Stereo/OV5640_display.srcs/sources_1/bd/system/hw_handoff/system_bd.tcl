...
proc create_root_design { parentCell } {
  ...
  # Create instance: HDMI_TX_1, and set properties
  set HDMI_TX_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:HDMI_TX:1.0 HDMI_TX_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {SD 1#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_interconnect_1_M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins axi_vdma_1/S_AXI_LITE]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_3_M00_AXI] [get_bd_intf_pins axi_interconnect_3/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_4_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_1_M_AXIS_MM2S] [get_bd_intf_pins axi_vdma_1/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_vdma_1_M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_vdma_1_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_3/S00_AXI] [get_bd_intf_pins axi_vdma_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_vdma_1_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_3/S01_AXI] [get_bd_intf_pins axi_vdma_1/M_AXI_S2MM]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_vid_in_axi4s_0_video_out] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets v_vid_in_axi4s_1_video_out]
  ...
  connect_bd_net -net OV5640_Sensor_0_rgb_o [get_bd_pins OV5640_Sensor_0/rgb_o] [get_bd_pins system_ila_1/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_data]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets OV5640_Sensor_0_rgb_o]
  ...
  connect_bd_net -net OV5640_Sensor_1_rgb_o [get_bd_pins OV5640_Sensor_1/rgb_o] [get_bd_pins system_ila_1/probe2] [get_bd_pins v_vid_in_axi4s_1/vid_data]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets OV5640_Sensor_1_rgb_o]
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_3/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins HDMI_TX_0/PXLCLK_I] [get_bd_pins HDMI_TX_1/PXLCLK_I] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_axi4s_vid_out_1/vid_io_out_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tc_1/clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins HDMI_TX_0/PXLCLK_5X_I] [get_bd_pins HDMI_TX_1/PXLCLK_5X_I] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins HDMI_TX_0/LOCKED_I] [get_bd_pins HDMI_TX_0/RST_N] [get_bd_pins HDMI_TX_1/LOCKED_I] [get_bd_pins HDMI_TX_1/RST_N] [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_axi4s_vid_out_1/aclken] [get_bd_pins v_axi4s_vid_out_1/aresetn] [get_bd_pins v_axi4s_vid_out_1/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tc_1/clken] [get_bd_pins v_tc_1/resetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_1/aclken] [get_bd_pins v_vid_in_axi4s_1/aresetn] [get_bd_pins v_vid_in_axi4s_1/axis_enable]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins OV5640_Sensor_0/clk_i] [get_bd_pins OV5640_Sensor_1/clk_i] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset] [get_bd_pins v_axi4s_vid_out_1/vid_io_out_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset] [get_bd_pins v_vid_in_axi4s_1/vid_io_in_reset]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins HDMI_TX_0/VGA_RGB] [get_bd_pins system_ila_1/probe0] [get_bd_pins v_axi4s_vid_out_0/vid_data]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets v_axi4s_vid_out_0_vid_data]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken] [get_bd_pins v_tc_1/gen_clken]
  connect_bd_net -net v_axi4s_vid_out_1_vid_active_video [get_bd_pins HDMI_TX_1/VGA_DE] [get_bd_pins v_axi4s_vid_out_1/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_1_vid_data [get_bd_pins HDMI_TX_1/VGA_RGB] [get_bd_pins system_ila_1/probe3] [get_bd_pins v_axi4s_vid_out_1/vid_data]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets v_axi4s_vid_out_1_vid_data]
  connect_bd_net -net v_axi4s_vid_out_1_vid_hsync [get_bd_pins HDMI_TX_1/VGA_HS] [get_bd_pins v_axi4s_vid_out_1/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_1_vid_vsync [get_bd_pins HDMI_TX_1/VGA_VS] [get_bd_pins v_axi4s_vid_out_1/vid_vsync]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_vdma_0/s_axis_s2mm_tkeep] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_vdma_1/s_axis_s2mm_tkeep] [get_bd_pins xlconstant_1/dout]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_vdma_1/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_1/S_AXI_LITE/Reg] SEG_axi_vdma_1_Reg
