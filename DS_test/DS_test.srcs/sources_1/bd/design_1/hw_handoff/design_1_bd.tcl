...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_ports clk_out5_0] [get_bd_pins clk_wiz_0/clk_out5]
  connect_bd_net -net clk_wiz_0_clk_out6 [get_bd_ports clk_out6_0] [get_bd_pins clk_wiz_0/clk_out6]
  connect_bd_net -net clk_wiz_0_clk_out7 [get_bd_ports clk_out7_0] [get_bd_pins clk_wiz_0/clk_out7]
